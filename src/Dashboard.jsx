...
const AGENCIES = [
  {
    ...
    hq: "Ceres Neutral Zone — IA Secretariat Complex",
    ...
    offices: [{ code: "IA-CERES", loc: "Ceres Neutral Zone", note: "Primary Secretariat" }, { code: "IALN–Luna", loc: "Luna Orbit", note: "Inner System diplomatic hub" }, { code: "IALN–Mars", loc: "Mars Orbit (outside Red Line)", note: "MF liaison" }, { code: "IADS–Ganymede", loc: "Ganymede, JFA (neutral zone)", note: "Embassy-level; JFA Crown Territory" }, { code: "IACH–FarReach", loc: "Saturn Orbit (high-inclination)", note: "TKA frontier + SatCon liaison" }],
    color: "#6ab0ff",
  },
  {
    ...
    treatiesToAdminister: "Navigation Safety Protocol (NSP), Propulsion Compliance Accord (PCA)",
    offices: [{ code: "INA-GAN", loc: "Ganymede, JFA", note: "Primary HQ · Standards Council, Hazard Core, Telemetry Vaults" }, { code: "INAO–Earth", loc: "Earth Orbit", note: "Inner-system traffic, burn scheduling, reactor investigations" }, { code: "INAO–Ceres", loc: "Ceres, Belt", note: "Belt traffic, industrial certification, debris mapping" }, { code: "INAO–Callisto", loc: "Callisto, JFA", note: "Jovian–Saturnian routes, radiation corridors" }, { code: "INAO–FarReach", loc: "FarReach Gateway, Saturn Orbit", note: "TKOS convoys, telemetry, deep-frontier hazards" }],
    color: "#f0c030",
  },
  {
  ...
  },
  {
    ...
    offices: [{ code: "IEA-MHEA", loc: "Mars High-Orbit", note: "Primary HQ · Climate, Planetary Protection, Terraforming Ethics" }, { code: "IEAO–Earth", loc: "Earth Stratospheric Platform", note: "Climate data, pollution assessment, biogeochemical modelling" }, { code: "IEAO–Ceres", loc: "Ceres, Belt", note: "Extraction impact audits, regolith contamination modelling" }, { code: "IEAO–Callisto", loc: "Callisto, JFA", note: "Radiation ecology, cryo-plume analysis, outer biosphere risks" }, { code: "IEAO–Titan", loc: "Titan Orbit, SatCon", note: "Titan atmospheric chemistry, prebiotic hydrocarbon protection" }],
    color: "#60d860",
  },
  {
    ...
    treatiesToAdminister: "System Medical Standards Convention (SMSC), Biohazard Rapid Response Protocol (BRRP), Frontier Medical Readiness Accord (FMRA)",
    offices: [{ code: "IHC-EL2", loc: "Earth–Luna L2, TLC", note: "Primary HQ · Epidemiology, Frontier Health Command, Pharma Harmonisation" }, { code: "IHCO–Earth", loc: "Earth, TLC", note: "Terran pathogen tracking, population health metrics" }, { code: "IHCO–Mars", loc: "Mars, MF", note: "Regolith biohazard lab, terraforming health risks" }, { code: "IHCO–Ceres", loc: "Ceres, Belt", note: "Occupational health, low-G physiology, bone-density studies" }, { code: "IHCO–Ganymede", loc: "Ganymede, JFA", note: "Radiation medicine, cellular damage modelling, Jovian biosurveillance" }, { code: "IHCO–Titan", loc: "Titan, SatCon", note: "Cryo-pathogen observatory, hydrocarbon biosignatures, contamination risk" }],
    color: "#e080c0",
  },
  {
    ...
    offices: [{ code: "IFE-TGFR", loc: "Earth Geostationary Orbit, TLC", note: "Primary HQ · MGB, SCA, Commodity Council, Anti-Fraud Bureau" }, { code: "IFEO–Mars", loc: "Mars Orbit", note: "Settlement disputes, Belt & Martian financial audits" }, { code: "IFEO–Ceres", loc: "Ceres, Belt", note: "Regolith metals, volatiles, isotope & cryo-chemical valuations" }, { code: "IFEO–Ganymede", loc: "Ganymede, JFA", note: "He-3 futures, heavy-resource markets, Jovian energy indices" }, { code: "IFEO–Titan", loc: "Titan Orbit, SatCon", note: "Titan hydrocarbon pricing, methane-chain commodity stability" }],
    color: "#c8a040",
  },
  {
    ...
    treatiesToAdminister: "Inter-bloc Judicial Cooperation Convention (IJCC), Piracy & Maritime Crime Accord (PMCA)",
    offices: [{ code: "IJC-EL1", loc: "Earth–Luna L1, TLC", note: "Primary HQ · High Tribunal, Criminal Division, Arbitration Bench" }, { code: "IJCO–Ceres", loc: "Ceres, Belt", note: "Belt disputes, frontier legal claims" }, { code: "IJCO–Mars", loc: "Mars Orbit", note: "Industrial crimes, regolith exploitation, labour violations" }, { code: "IJCO–Callisto", loc: "Callisto, JFA", note: "Piracy, convoy raids, navigation fraud, Jovian violent crime" }, { code: "IJCO–Titan", loc: "Titan, SatCon", note: "TKA violations, frontier prosecutions, deep-system incidents" }],
    color: "#e05a3a",
  },
  {
    ...
    treatiesToAdminister: "SAPC, HLASC, TCBA, SREC, FSAP",
    offices: [{ code: "ISA-CL4", loc: "Ceres L4, Belt", note: "Primary HQ · Scientific Access Council, Ethics, HRTRB, FSIO" }, { code: "ISAO–Earth", loc: "Earth, TLC", note: "Terran academia, climate research, planetary science" }, { code: "ISAO–Mars", loc: "Mars, MF", note: "Surface access, geologic sampling, terraforming-impact studies" }, { code: "ISAO–Europa", loc: "Europa Orbit, JFA", note: "Icy moon access, cryovolcanic plume research, bio-signature controls" }, { code: "ISAO–Titan", loc: "Titan, SatCon", note: "Hydrocarbon chemistry, high-risk chemical experimentation" }, { code: "ISAO–FRG", loc: "FarReach Gateway", note: "TKA research, frontier mission approvals, trans-Neptunian protocols" }],
    color: "#a060e0",
  },
  {
    ...
    offices: [{ code: "ITC-EM", loc: "Earth Orbit + Mars Orbit (dual HQ)", note: "Primary HQ · Trade Secretariat (Earth) + Tariff Directorate (Mars)" }, { code: "ITCO–Ceres", loc: "Ceres, Belt", note: "Raw materials certification, Belt industrial exports, tariff mediation" }, { code: "ITCO–Ganymede", loc: "Ganymede, JFA", note: "High-mass freight, cryo-fuel exports, Jovian customs compliance" }, { code: "ITCO–Titan", loc: "Titan Orbit, SatCon", note: "Hydrocarbon trade standards, anti-smuggling surveillance" }, { code: "ITCO–FarReach", loc: "FarReach Gateway", note: "Trans-Neptunian import controls, frontier sample commercialisation" }],
    color: "#f0a030",
  },
  {
        ...
        {tab === "agencies" && (
          <div>
            ...
            <div style={{ marginTop: 24, padding: "14px 16px", border: "1px solid rgba(255,255,255,0.06)", borderRadius: 2 }}>
              ...
              {[
                { loc: "Earth / Earth Orbit / EL1–L2", agencies: ["IJC (EL1-JC — HQ)", "ICC (EL2 — HQ)", "IHC (EL2-BioNex — HQ)", "IFE (TGFR — HQ)", "INA (INAO–Earth)", "ITC (EOTS — HQ)", "ISA (ISAO–Earth)", "IHCO–Earth"] },
                { loc: "Mars / Mars Orbit", agencies: ["IEA (MHEA — HQ)", "INA (INAO)", "ICC (ICCO)", "IJC (IJCO — Criminal Field Wing)", "IFE (IFEO — Settlement Hub)", "ITC (MOTD — HQ)", "ISA (ISAO)", "IHC (IHCO)"] },
                { loc: "Ceres / Belt", agencies: ["ISA (CL4-SAC — HQ)", "IA (Secretariat — HQ)", "INA (INAO)", "ICC (ICCO)", "IEA (IEAO)", "IFE (IFEO — Commodity)", "IJC (IJCO — Arbitration)", "ITC (ITCO — Belt Bureau)", "IHC (IHCO — Occupational)"] },
                { loc: "Ganymede / Callisto / JFA", agencies: ["INA (GAN — HQ)", "ICC (ICCO–Ganymede)", "IEA (IEAO–Callisto)", "IFE (IFEO–Ganymede)", "IJC (IJCO–Callisto — Piracy Unit)", "ITC (ITCO–Ganymede)"] },
                { loc: "Europa / JFA", agencies: ["ISA (ISAO–Europa — Cryo-Oceanic Lab)"] },
                { loc: "Titan / Saturn / SatCon", agencies: ["IEA (IEAO–Titan)", "IHC (IHCO–Titan — Cryo-Pathogen)", "IFE (IFEO–Titan)", "IJC (IJCO–Titan — Frontier Liaison)", "ISA (ISAO–Titan)", "ITC (ITCO–Titan)", "TKA (IA liaison)"] },
